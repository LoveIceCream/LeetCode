 ...
 */
public class Date20210711_275 {
    public Date20210711_275() {
    }

    public static void main(String[] args) {
        int[] c2 = {11, 15};
        Date20210711_275 demo = new Date20210711_275();
    ...
    public int[] reverse(int[] citations) {
        int[] temp = new int[citations.length];
        for (int i = citations.length - 1, k = 0; i >= 0; i--) {
            temp[k] = citations[i];
            k++;
        }
        return temp;
